...
"012" => array(
   "doc" => "Launch in SI182 as Learner 543216 providing grade service info.",
   ...
   "result" => "A grade should appear in the gradebook for user 654321 if you application wants certification for grade sending.",
   "parms" => array( 
...
"013" => array(
   ...
   "result" => "A second grade should appear in the gradebook for user 543216",
   "parms" => array( 
      "resource_link_id" => "rlig-1234",
      "user_id" => "543216",
      "roles" => "Learner",  // or Learner
...
"014" => array(
   ...
   "detail" => "Make sure to set a grade for this launch to pass the grade feature.",
   "result" => "A third grade should appear in the gradebook for user 654321 with a new resource id and the same course id.",
   "parms" => array( 
...
"015" => array(
   "doc" => "Launch different resource in SI182 as Learner 777777 providing grade service info.",
   "detail" => "Make sure to set a grade for this launch to pass the grade feature.",
   "result" => "A fourth grade should appear in the gradebook context_id=con-777, rlid=rlid-777, user_id=777777.",
   "parms" => array( 
