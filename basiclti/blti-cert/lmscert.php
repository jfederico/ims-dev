...
$good_name = false;
if ( ( isset($_REQUEST['lis_person_name_given']) and 
       isset($_REQUEST['lis_person_name_family']) ) or
       isset($_REQUEST['lis_person_name_full']) ) {
    $good_name = true;
}

if ( $good_name and
     isset($_REQUEST['lis_person_contact_email_primary']) ) {
    mark_pass("4.5", "Full User Info");
}

if ( ! isset($_REQUEST['lis_person_name_given']) and 
     ! isset($_REQUEST['lis_person_name_family']) and  
     ! isset($_REQUEST['lis_person_name_full']) and
     isset($_REQUEST['lis_person_contact_email_primary']) ) {
...
if ( isset($_REQUEST['lis_person_name_given']) or 
     isset($_REQUEST['lis_person_name_family']) or  
     isset($_REQUEST['lis_person_name_full']) or
     isset($_REQUEST['lis_person_contact_email_primary']) ) {
    // pass
} else { 
...
if ( isset($_REQUEST['context_label']) ) mark_pass("5.2", "Sends context_label");
if ( isset($_REQUEST['context_title']) ) mark_pass("5.3", "Sends context_title");
...
if ( isset($_REQUEST['lis_result_sourcedid']) && isset($_REQUEST['lis_outcome_service_url']) ) {
   ...
   print '<a href="tool_provider_outcome.php?sourcedid='.
      urlencode($sourcedid);
